...
$form['form-1'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'NotaLex – Зворотній дзвінок',
    'title' => 'NotaLex – Зворотній дзвінок',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
    'to_email' => 'sasha.vovk03@gmail.com',
    ...
    'okay' => '
    <div class="modal-item-ob">
      <p class="modal-item-head">
        Дякуємо ми вам<br> передзвонимо протягом 15хв.
      </p>
    </div>
    ',
    'fuck' => 'Повідомлення відправлено - ERROR',
    'spam' => 'Cпам робот',
...
$form['form-2'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'NotaLex – Консультація за телефоном',
    'title' => 'NotaLex – Консультація за телефоном',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
...
$form['form-3'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'NotaLex – Послуга',
    'title' => 'NotaLex – Послуга',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
...
$form['form-4'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'NotaLex – Бесплатная консультация',
    'title' => 'NotaLex – Бесплатная консультация',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
...
if(isset($form[$act])) {
   ...
   $sb = array(); // subject и body
      foreach($form['fields'] as $name => $field) {
            ...
            $rawdata = isset($_POST[$name]) ? trim($_POST[$name]) : '';
              if(isset($field['validate'])) {
                  $def = 'Поле з імям [ '.$name.' ] має помилку.';
                  // -0-
    ...
    $error[] = 'Немає налаштувань форми з імям #'.$act;
 }
    if(count($error) > 0) {
