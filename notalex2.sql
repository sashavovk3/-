...
--
-- Структура таблицы `kind_of_services`
--
...
--
-- Дамп данных таблицы `kind_of_services`
--
...
--
-- Индексы таблицы `affairs`
--
ALTER TABLE `affairs`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `kind_of_services`
--
