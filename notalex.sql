...
--
-- Дамп данних таблиці `kind_of_services`
--
...
--
-- Индекси збережених таблиць
--

--
-- Індекс таблиці `affairs`
--
ALTER TABLE `affairs`
  ADD PRIMARY KEY (`id`);

--
-- Індекс таблиці `kind_of_services`
--
...
--
-- AUTO_INCREMENT для збереження таблиць
--

--
-- AUTO_INCREMENT для таблиці `affairs`
--
ALTER TABLE `affairs`
  MODIFY `id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблиці `kind_of_services`
--
ALTER TABLE `kind_of_services`
